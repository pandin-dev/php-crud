                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="nome" 
                                       name="nome" 
                                       value="<?= htmlspecialchars($_SESSION['old_data']['nome'] ?? $user['nome']) ?>"
                                       required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="email" 
                                       ...
                                       id="email" 
                                       name="email" 
                                       value="<?= htmlspecialchars($_SESSION['old_data']['email'] ?? $user['email']) ?>"
                                       required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="telefone" 
                                       name="telefone" 
                                       value="<?= htmlspecialchars($_SESSION['old_data']['telefone'] ?? $user['telefone']) ?>"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" 
                                       ...
                                       value="<?= htmlspecialchars($_SESSION['old_data']['data_nascimento'] ?? $user['data_nascimento']) ?>"
                                       required>
